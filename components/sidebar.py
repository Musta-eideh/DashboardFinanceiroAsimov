...
layout = dbc.Col([
        ...
        # Seção NOVO
            ...
            # Seção Modal Receita
                ...
                style={"background-color":"rgb(17, 140, 79, 0.05)"},
                ...
                dbc.Modal([
                    ...
                    dbc.ModalBody([
                        dbc.Row([
                            dbc.Col([
                                dbc.Label('Descrição: '),
                                dbc.Input(placeholder="Transporte, refeição...", id="txt-despesa")
                            ], width=6),
                            dbc.Col([
                                dbc.Label("Valor: "),
                            ...
                            dbc.Accordion([
                                dbc.AccordionItem(children=[
                                    dbc.Row([
                                        dbc.Col([
                                            html.Legend("Adicionar categoria", style={'color':'green'}),
                                            dbc.Input(type="text", placeholder="Nova categoria...", id="add-category-despesa", style={"margin-top":"20px"}),
                                            html.Br(),
